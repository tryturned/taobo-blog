/* 
copy from https://lewky.cn/posts/hugo-3.html/
*/
/* 返回随机颜色 */
...
/* 轮播背景图片  https://blog.csdn.net/weixin_30794851/article/details/99023580*/
$(function () {
	$.backstretch([
		"/images/lighthouse-large.jpg",
		// "/images/Wavelength.jpg",
	], { duration: 600, fade: 1500 });
});
...
function runtime() {
    ...
    let startTime = new Date('12/24/2021 15:00:00');
